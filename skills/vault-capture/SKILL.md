...
git add <書いたファイルを明示>
git log -1 --pretty='%an <%ae>'   # parin1213 / parin1213@gmail.com であること（業務 identity 混入禁止）
git commit -F <一時ファイル>       # 日本語メッセージ、Conventional prefix は英語
git push origin main
```

identity が業務のままなら `git config user.name parin1213; git config user.email parin1213@gmail.com`
